...
| `hod2lib/` | 14872 | 34 | engine |
| `render/` | 8003 | 29 | render |
| `app/` | 7248 | 29 | app |
| `script/` | 3630 | 25 | engine |
| `ui/` | 3032 | 26 | ui |
...
| | |
|---|---|
| Named functions | 686 in `ghidra/annotations/functions.tsv` |
| Named globals | 357 in `ghidra/annotations/globals.tsv` |
