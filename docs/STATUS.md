...
| `[open]` markers in `game/` | **159** — questions the port is honest about not having answered |
...
11 of them need the installed game and 6 need an exported
