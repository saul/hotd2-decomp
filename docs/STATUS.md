...
|---|---:|---:|---|
| `game/` | 39903 | 153 | engine |
| `hod2lib/` | 15613 | 34 | engine |
...
| | |
|---|---|
| Named functions | 851 in `ghidra/annotations/functions.tsv` |
...
10 of them need the installed game and 4 need an exported
