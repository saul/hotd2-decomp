...
| `[open]` markers in `game/` | **119** — questions the port is honest about not having answered |
...
| | |
|---|---|
| Named functions | 723 in `ghidra/annotations/functions.tsv` |
| Named globals | 366 in `ghidra/annotations/globals.tsv` |
