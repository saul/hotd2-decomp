...
|---|---:|---:|---|
| `game/` | 39978 | 154 | engine |
| `hod2lib/` | 15635 | 34 | engine |
| `render/` | 8091 | 29 | render |
| `app/` | 7337 | 29 | app |
| `script/` | 4144 | 25 | engine |
| `ui/` | 3094 | 26 | ui |
| `bundle/` | 2101 | 11 | engine |
| `core/` | 904 | 9 | engine |
| `audio/` | 351 | 1 | render |
| `hud/` | 349 | 1 | ui |
| **total** | **81984** | **319** | |
...
| Citations checked | 311 ported functions match `functions.tsv` under the same name |
