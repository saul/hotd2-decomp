...
| `0x14`, `0x32` | — | 5/2 | **Enemies**, both incrementing both enemy counters. | `[proved]` |
...
| `0x19`, `0x32` | — | 4/2 | **Enemies**, both incrementing both enemy counters. `0x19` takes ~15 per-bone model slots straight from its tail. | `[proved]` |
