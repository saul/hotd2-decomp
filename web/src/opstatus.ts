...
put("shown", 0x2b, 0x2f, 0x31, 0x32, 0x33, 0x49, 0x4a, 0x4b);

// The skip feature. Dead in the retail build only because the Start poll
// writes a global nothing reads; 0x2C, the wait tests and 0x2E are all live
// and are honoured here, with the UI supplying the missing assignment.
put("done", 0x2c, 0x2e);
